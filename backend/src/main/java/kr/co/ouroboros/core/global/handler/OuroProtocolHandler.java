...
public interface OuroProtocolHandler {
     ...
     *
     * @return the file system path or classpath location of the Ouro API specification YAML for
     * this protocol
     */
     ...
     *
     * @return the {@code OuroApiSpec} representing the API specification discovered in the codebase
     * via annotations
     */
     ...
     *
     * @param yamlContent the full contents of a YAML (.yml) file representing an Ouro API
     *                    specification
    ...
    /**
     * Compare a persisted API spec with the scanned current API spec and produce a validation spec
     * that describes their discrepancies.
     *
     * @param fileSpec    the API specification loaded from the persisted file (desired state)
     * @param scannedSpec the API specification produced by scanning the current codebase (actual
     *                    state)
