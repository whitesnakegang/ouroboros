 ...
 * <b>Key Components:</b>
 * <ul>
 *   <li>{@link kr.co.ouroboros.core.global.tryit.infrastructure.instrumentation.sampler.TryOnlySampler} -
 ...
 * {@link kr.co.ouroboros.core.global.tryit.config.TraceStorageConfig} with
 * @AutoConfigureBefore to ensure it takes precedence over Spring Boot's default Sampler.
 *
 * @author Ouroboros Team
 * @since 0.0.1
 */
package kr.co.ouroboros.core.global.tryit.infrastructure.instrumentation.sampler;