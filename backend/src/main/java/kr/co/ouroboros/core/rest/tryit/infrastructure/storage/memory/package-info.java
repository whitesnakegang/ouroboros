 ...
 * compatible with the existing TempoClient interface.
 * <p>
 * <b>Components:</b>
 * <ul>
 *   <li><b>InMemoryTraceStorage</b> - Thread-safe in-memory storage for traces</li>
 *   <li><b>InMemoryTraceClient</b> - TraceClient implementation using in-memory storage</li>
 ...
 * in memory and can be retrieved using the same TempoClient interface.
 * <p>
 * <b>Configuration:</b>
 * <pre>{@code
